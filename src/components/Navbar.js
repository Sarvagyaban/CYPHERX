...
const Navbar = () => {
  ...
  return (
    <div className="">
      <div className="displayButton" style={{ textAlign: "center" ,fontFamily:"revert-layer"}} >
        <button className="headerButton"onClick={() => setDisplayOnClick(!displayOnClick)} style={{ "float": "left", marginTop:'8px'}}>
          {" "}
          <TiThList /> Display  ▼
        </button>
        <span style={{fontSize:'25px'}}>Cypherx Assignment Kanban Board</span>
<span style={{ "float": "right", marginTop:'8px'}}> Designed By - <a href="https://sarvagyaban.github.io/Portfolio/" target="blank">Sarvagya Bansal</a></span>
        {displayOnClick && (
          <>
